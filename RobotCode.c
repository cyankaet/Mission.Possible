...
#pragma config(Motor,  port7,           tets,          tmotorServoStandard, openLoop)
...
/*
*	collects the gravel by turning on the motor that is connected to our collector
*/
void pullGravel()
{
	motor[flag] = -30;
...
/*our programmed, "automated rove" that was calculated and tested
*/
void autoMove() {
	//left 1.23
	motor[rightMotor] = 63;
...
/*
*displays the given number on the binary led DISPLAY, WHICH WE WILL CONVERT BACK TO DECMAL
*/
...
/*
* meaure for ten seconds, every second, and stores in array to be displayed in the future
*/
void tempSense()
{
	printData();
...
/*
* moves the robot to be pointed in the direction of the sun
*/
void lightSense()
